(function(e) {
    if ("function" == typeof bootstrap) bootstrap("nedb", e);
        ...
        if (!ses.ok()) return;
        ses.makeNedb = e
    } else "undefined" != typeof window ? window.Nedb = e() : global.Nedb = e()
})(function() {
    ...
    return (function(e, t, n) {
        ...
        }, { "./cursor": 5, "./customUtils": 6, "./executor": 8, "./indexes": 9, "./model": 10, "./persistence": 11, "async": 13, "underscore": 19, "util": 3 }],
        ...
        }, { "./customUtils": 6, "./indexes": 9, "./model": 10, "./storage": 12, "__browserify_process": 4, "async": 13, "path": 2 }],
                                ...
                                function _initStorage(options) {
                                    ...
                                    return Promise.all(readyPromises).then(function() {
                                        ...
                                        for (var k in forages) {
                                            ...
                                            if (forage !== self && forage._dbInfo !== undefined) {
